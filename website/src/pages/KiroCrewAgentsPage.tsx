...
export default function KiroCrewAgentsPage({ embedded }: { embedded?: boolean } = {}) {
  ...
  const [discardAsk, setDiscardAsk] = useState<CrewPaneKey | 'close' | 'chat' | null>(null)
            ...
            {creating ? (
              ...
              <>
                ...
                >
                  ...
                  {pane === 'schedules' && (
                    <CrewWakeSection crew={editing} isDefaultCrew={editing === defaultAgent} onDraftChange={setSchedDraft} onSavingChange={setSchedSaving} />
                  )}
